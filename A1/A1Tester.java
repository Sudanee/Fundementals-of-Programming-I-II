...
public class A1Tester {
	...
	public static void testNumFactors() {
		...
		System.out.println("Testing numFactors(28)");
		result = A1Exercises.numFactors(28);
		expected = 6; // There are 4 factors of 51: 1,3,17,51
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	}
	...
	public static void testGreatestCommonDenominator() {
		...
		System.out.println("Testing greatestCommonDenominator(2,3)");
		result = A1Exercises.greatestCommonDenominator(2,3);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(25,5)");
		result = A1Exercises.greatestCommonDenominator(25,5);
		expected = 5;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		// Write tests here
	...
	public static void testCountMatches() {
		...
		int expected = 0;
		int[] arr1 = {2, 3, 2, 0};
		int[] arr2 = {-1, 2, 4, 1, 4, 4};
		int[] arr3 = {-5, 2, 8, 10, 7, -5, -5};
		int[] arr4 = {};
		// add more arrays
		...
		System.out.println("Testing countMatches(arr2, 4)");
		result = A1Exercises.countMatches(arr2, 4);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing countMatches(arr2, -1)");
		...
		System.out.println("Testing countMatches(arr3, 11)");
		result = A1Exercises.countMatches(arr3, 11);
		expected = 0;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing countMatches(arr4, 11)");
		result = A1Exercises.countMatches(arr4, 11);
		expected = 0;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
